...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/50 to-teal-50/30 flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 order-2 lg:order-1">
        ...
        >
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-slate-600">Sign in to access your evidence library</p>
          </div>
      ...
      {/* Decorative Section - Hidden on mobile, shown on lg */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-blue-500 via-teal-500 to-emerald-500 items-center justify-center p-12 order-1 lg:order-2">
        <motion.div
        ...
        >
          ...
          <p className="text-white/80 text-lg">
            Your evidence is encrypted, timestamped, and ready when you need it most.
          </p>
          ...
          <div className="mt-12 flex justify-center gap-4">
            <motion.div
              ...
              className="w-16 h-16 bg-white/10 backdrop-blur-sm rounded-2xl"
            />
            <motion.div
              animate={{ y: [0, -10, 0] }}
      ...
      <div className="lg:hidden bg-gradient-to-br from-blue-500 via-teal-500 to-emerald-500 p-6 sm:p-8 order-1">
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <h2 className="text-xl sm:text-2xl font-bold mb-1 sm:mb-2">Protect What Matters</h2>
          <p className="text-white/80 text-sm sm:text-base">
            Your evidence, encrypted and ready.
          </p>
        </motion.div>
      </div>
    </div>
